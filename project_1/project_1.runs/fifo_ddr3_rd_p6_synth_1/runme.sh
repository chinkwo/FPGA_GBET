...
HD_PWD='F:/FPGA_VIVADO/FPGA_GBET/project_1/project_1.runs/fifo_ddr3_rd_p6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ddr3_rd_p6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ddr3_rd_p6.tcl
