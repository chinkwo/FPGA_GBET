...
HD_PWD='F:/FPGA_VIVADO/FPGA_GBET/project_1/project_1.runs/wr_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wr_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wr_data.tcl
