...
HD_PWD='F:/FPGA_VIVADO/FPGA_GBET/project_1/project_1.runs/A7_ddr3_mig_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A7_ddr3_mig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A7_ddr3_mig.tcl
