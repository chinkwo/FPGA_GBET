...
HD_PWD='F:/FPGA_VIVADO/FPGA_GBET/project_1/project_1.runs/fifo_in32_o128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_in32_o128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_in32_o128.tcl
