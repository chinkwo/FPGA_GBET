...
HD_PWD='F:/FPGA_VIVADO/FPGA_GBET/project_1/project_1.runs/fifo_in128_o32_2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_in128_o32_2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_in128_o32_2048.tcl
