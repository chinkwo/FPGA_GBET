...
#
# Generated by export_simulation on Mon Apr 02 19:37:06 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './fifo_ddr3_rd_p6.sh' script.

./fifo_ddr3_rd_p6.sh -reset_run
...
./fifo_ddr3_rd_p6.sh -noclean_files

For more information on the script, please type './fifo_ddr3_rd_p6.sh -help'.
