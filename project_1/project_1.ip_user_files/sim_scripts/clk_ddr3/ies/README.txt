...
#
# Generated by export_simulation on Tue Mar 20 16:51:31 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './clk_ddr3.sh' script.

./clk_ddr3.sh -reset_run
...
./clk_ddr3.sh -noclean_files

For more information on the script, please type './clk_ddr3.sh -help'.
