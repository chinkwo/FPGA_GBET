...
#
# Generated by export_simulation on Tue Mar 20 16:39:52 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './ram_64x8.sh' script.

./ram_64x8.sh -reset_run
...
./ram_64x8.sh -noclean_files

For more information on the script, please type './ram_64x8.sh -help'.
