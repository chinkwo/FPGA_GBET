...
#
# Generated by export_simulation on Mon Apr 02 15:30:44 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './ram_2048x8.sh' script.

./ram_2048x8.sh -reset_run
...
./ram_2048x8.sh -noclean_files

For more information on the script, please type './ram_2048x8.sh -help'.
