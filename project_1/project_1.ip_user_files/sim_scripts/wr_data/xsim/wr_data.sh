...
#
# Generated by Vivado on Mon May 07 20:33:48 +0800 2018
...
# Script info
echo -e "wr_data.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot wr_data xil_defaultlib.wr_data xil_defaultlib.glbl -log elaborate.log
}
